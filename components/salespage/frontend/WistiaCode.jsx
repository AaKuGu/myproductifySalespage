...
const WistiaCode = () => {
  return (
    <>
      ...
      <script
        src="https://fast.wistia.com/embed/medias/3pc5c5kbv1.jsonp"
        async
      ></script>
      <script
        src="https://fast.wistia.com/assets/external/E-v1.js"
      ...
      >
        ...
        >
          <div
            class="wistia_embed wistia_async_3pc5c5kbv1 seo=true videoFoam=true"
            style={{ height: "100%", position: "relative", width: "100%" }}
          >
            <div
              class="wistia_swatch"
            ...
            >
              <img
                src="https://fast.wistia.com/embed/medias/3pc5c5kbv1/swatch"
                style={{
                  filter: "blur(5px)",
                  height: "100%",
                  objectFit: "contain",
