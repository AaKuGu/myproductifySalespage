  ...
  return (
    <div className="flex flex-col gap-3 px-5 py-2 items-center justify-center">
      <a
        ...
        className="py-2 sm:py-4 md:py-6 lg:py-8 px-2 sm:px-3 md:px-4 bg-orange-500 text-[16px] sm:text-lg md:text-xl lg:text-2xl font-extrabold tracking-wide rounded-[15px] sm:rounded-[18px] md:rounded-[20px] pulse"
      >
